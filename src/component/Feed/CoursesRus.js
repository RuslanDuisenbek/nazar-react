...
import akcentImage from './../assets/akcentCOurse.svg'
const CoursesRus = () => {
  return (
    <div className='flex w-full flex-col justify-center items-center'>
        ...
        <div className='flex flex-col justify-center w-[70%] '>
          <div className='w-full'>
            <text className='font-poppins font-bold text-[200%] leading-[72px] tracking-normal'>
              Курс русского языка от Akcent Academy
            </text>
          </div>
          <div>
      ...
      <div className='w-[90%] h-auto flex justify-start items-center'>
        <iframe
          width="600"
          height="340"
          src="https://www.youtube.com/embed/ZvpngHhv2Zo"
          title="YouTube Video"
          frameBorder="0"
